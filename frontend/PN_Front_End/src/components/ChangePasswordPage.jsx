          ...
          <form onSubmit={handleSubmit} className="bg-white p-8 md:p-12 border-2 border-brand-forestDark shadow-[8px_8px_0px_0px_rgba(22,44,28,1)] rounded relative z-10 space-y-6">
            ...
            {success ? (
              <div className="text-center py-10 animate-scale-up">
                ...
                <h2 className="font-syne text-3xl font-black text-brand-forestDark uppercase mb-2">Password Changed!</h2>
                <p className="text-brand-dark/70 text-sm font-medium">Your password has been updated. Redirecting...</p>
              </div>
            ) : (
              <>
                <header>
                ...
                <div className="flex flex-col space-y-2">
                  <label className="block font-space font-black text-xs text-brand-forestDark uppercase tracking-widest" htmlFor="oldPassword">
                    Current Password
                  </label>
                ...
                <div className="flex flex-col space-y-2">
                  <label className="block font-space font-black text-xs text-brand-forestDark uppercase tracking-widest" htmlFor="newPassword">
                    New Password
                  </label>
                  <div className="relative">
                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-brand-forestDark/40">
